...
@Mod(modid = LootableBodies.MODID, name = LootableBodies.NAME, version = LootableBodies.VERSION, acceptedMinecraftVersions = "[1.10.2,)")
public class LootableBodies {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		ticksPerItemDecay = (int) (60 * 20
				* config.getFloat("item_decay_rate", "options", 5F, -1F, 1e9F,
	...
	private void registerEntity(Class entityClass) {
		...
		EntityRegistry.registerModEntity(entityClass, idName,
				entityIndex++/* mod-specific entity id */, this, 32/* trackingRange */, 1/* updateFrequency */,
