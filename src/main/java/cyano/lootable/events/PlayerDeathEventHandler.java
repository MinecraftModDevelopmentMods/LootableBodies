...
public class PlayerDeathEventHandler {
	...
	public void playerDeathEvent(PlayerDropsEvent event) {
		if (event.entityLiving instanceof EntityPlayer) {
			...
			// System.out.println("Player "+player.getName()+" died. Entity on
			// "+(event.entity.worldObj.isRemote ? "client" : "server") + "
			// world.");
	...
	static boolean deepEquals(ItemStack a, ItemStack b) {
		return ItemStack.areItemsEqual(a, b) && ItemStack.areItemStacksEqual(a, b)
